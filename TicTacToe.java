...
public class TicTacToe extends Application {
    ...
    private BorderPane createContent() {
        ...
        titleLabel.setStyle("-fx-front-size : 24ft; -fx-font-weight : bold;");
        ...
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 3; j++) {
                ...
                button.setStyle("-fx-front-size : 35ft; -fx-font-weight : bold;");
    ...
    private void updateScore(String winner){
        if(winner.equals("X")){
            ...
            playerXScore++;
            playerXScoreLabel.setText("Player O :" +playerOScore);
        }
    }
